...
function floodFillCanvas(canvas, sx, sy, fillR, fillG, fillB, tolerance) {
...
export default {
  ...
  onPointerDown(e, toolCtx) {
    ...
    pushHistory('Fill')
    floodFillCanvas(layer.canvas, e.x - layer.offsetX, e.y - layer.offsetY, r, g, b, state.fillTolerance)
    state.isDirty = true
    invalidate()
  },
