...
// Composable for use inside Vue components (requires component context)
export function useAppTheme() {
  ...
  function setAccent(color) { _applyColor(color) }
...
export async function setup(ctx) {
  ctx.services.register('theme.service', { useAppTheme, ACCENT_COLORS }, 'theme')
}

export async function teardown(ctx) {
  ctx.services.unregister('theme.service', 'theme')
}
