...
- **图片** — 缩略图网格、原图平移/缩放查看器、左右对比滑动查看器；**图片编辑器**：多图层管理、15 种绘制/选择工具（移动、画笔、橡皮擦、裁剪、填充、渐变、文字、形状、套索、魔棒、模糊、涂抹等）、色调调整（亮度/对比度、曲线、色阶、色相/饱和度、色彩平衡、曝光/自然饱和度、阴影/高光）、WebGL 加速滤镜（高斯模糊、锐化、噪点、暗角、像素化、怀旧、浮雕、边缘检测、色差等）、撤销/重做历史、导出（可选格式与质量）
...
**后端：** Python 3.10+、FastAPI、Uvicorn、Polars、Pillow
